...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} className="text-slate-500 hover:text-blue-600 transition-colors duration-300">
    {children}
  </a>
);
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-slate-600 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} AI Service Enabler Professional Association. All rights reserved.
          </p>
          <div className="flex items-center space-x-6">
            <a href="#" className="text-sm text-slate-600 hover:text-blue-600">Home</a>
            <a href="#" className="text-sm text-slate-600 hover:text-blue-600">Privacy Policy</a>
            <a href="#" className="text-sm text-slate-600 hover:text-blue-600">Terms of Service</a>
